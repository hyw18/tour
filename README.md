...
최신 안정성 감사 기준 HEAD는 `dbf54825042eb60dfa877c7461762718024e9118`입니다.
자동 검증은 `172 passed, 1 skipped`이며, 4개 독립 세션 30라운드와 주요 변경 요청
100회 동시 전송을 통과했습니다. 실제 스마트폰 2~4대 검증은
`MANUAL_DEVICE_TEST_REQUIRED`로 남아 있습니다.
