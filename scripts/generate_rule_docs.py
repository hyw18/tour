...
TEST_BY_PREFIX = {
    ...
    "CONFIG": "tests/test_turn_step_timers.py:test_presets_and_official_response_timers_remain_independent; tests/test_routes.py",
    "TURN": "tests/test_turn_step_timers.py; tests/test_engine.py:test_turn_server_dice_forced_start_stop_and_round_increment",
...
def generate_matrix(data):
    ...
    lines = [
        "# 규칙 구현·테스트 대응표",
        "",
        "분석 기준 HEAD: `d0fa8bf2f4bfa7a5d99eeb35dbdda62c92123dd3` + working tree changes",
        f"기준 `rules_version`: `{data['rules_version']}`",
        "판정 시점: 2026-07-17. 최신 작업 트리의 226개 통과 테스트와 1개 skip을 다시 대조한 결과다.",
        "",
        "검증 상태는 `CODE_PRESENT`, `UNIT_TESTED`, `MULTI_CLIENT_TESTED`,",
        "`BROWSER_TESTED`, `REAL_DEVICE_TEST_REQUIRED`, `CONFLICT`, `UNRESOLVED`로 해석한다.",
        "이번 실행 환경에는 node/browser 실행 파일이 없어 브라우저 검증은 수행하지 못했다.",
        "물리 기기 검증은 별도로 `REAL_DEVICE_TEST_REQUIRED`다.",
        "",
        "## 플레이어 사용성 연결 상태",
        "",
        "| 항목 | 상태 | 근거 |",
